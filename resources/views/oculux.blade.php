    ...
    <div id="wrapper">
                    ...
                    <ul class="nav navbar-nav">
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu right_chat email vivify fadeIn">
                                ...
                                <li>
                                    <a href="javascript:void(0);">
                                        <div class="media">
                                            <img class="media-object " src="xor/up/assets/images/xs/avatar5.jpg" alt="">
                                            <div class="media-body">
                                ...
                                <li>
                                    <a href="javascript:void(0);">
                                        <div class="media mb-0">
                                            <img class="media-object " src="xor/up/assets/images/xs/avatar2.jpg" alt="">
                                            <div class="media-body">
                        ...
                        <li class="dropdown language-menu">
                            ...
                            <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                <a class="dropdown-item pt-2 pb-2" href="#"><img src="xor/up/assets/images/flag/us.svg " class="w20 mr-2 rounded-circle"> US English</a>
                                <a class="dropdown-item pt-2 pb-2" href="#"><img src="xor/up/assets/images/flag/gb.svg " class="w20 mr-2 rounded-circle"> UK English</a>
                                <div class="dropdown-divider"></div>
                                <a class="dropdown-item pt-2 pb-2" href="#"><img src="xor/up/assets/images/flag/russia.svg " class="w20 mr-2 rounded-circle"> Russian</a>
                                <a class="dropdown-item pt-2 pb-2" href="#"><img src="xor/up/assets/images/flag/arabia.svg " class="w20 mr-2 rounded-circle"> Arabic</a>
                ...
                <table class="table table-hover table-custom spacing5">
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex align-items-center">
                                    <img src="xor/up/assets/images/xs/avatar2.jpg" data-toggle="tooltip" data-placement="top" title="" alt="Avatar" class="w35 h35 rounded" data-original-title="Avatar Name">
                                    <div class="ml-3">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex align-items-center">
                                    <img src="xor/up/assets/images/xs/avatar5.jpg" data-toggle="tooltip" data-placement="top" title="" alt="Avatar" class="w35 h35 rounded" data-original-title="Avatar Name">
                                    <div class="ml-3">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex align-items-center">
                                    <img src="xor/up/assets/images/xs/avatar6.jpg" data-toggle="tooltip" data-placement="top" title="" alt="Avatar" class="w35 h35 rounded" data-original-title="Avatar Name">
                                    <div class="ml-3">
                    ...
                    <div class="tab-pane vivify fadeIn delay-100 active" id="Chat-one">
                        <div class="chat_detail">
                            <ul class="chat-widget clearfix">
                                ...
                                <li class="right">
                                    <img src="xor/up/assets/images/xs/avatar1.jpg" class="rounded" alt="">
                                    <div class="chat-info">
                    ...
                    <div class="tab-pane vvivify fadeIn delay-100" id="Chat-list">
                        <ul class="right_chat list-unstyled mb-0">
                            ...
                            <li class="online">
                                <a href="javascript:void(0);">
                                    <div class="media">
                                        <img class="media-object " src="xor/up/assets/images/xs/avatar3.jpg" alt="">
                                        <div class="media-body">
        ...
        <div id="left-sidebar" class="sidebar">
            <div class="navbar-brand">
                <a href="index.html"><img src="xor/up/assets/images/icon.svg" alt="Oculux Logo" class="img-fluid logo"><span>Oculux</span></a>
                <button type="button" class="btn-toggle-offcanvas btn btn-sm float-right"><i class="lnr lnr-menu icon-close"></i></button>
            </div>
            <div class="sidebar-scroll">
                <div class="user-account">
                    <div class="user_div">
                        <img src="xor/up/assets/images/user.png" class="user-photo" alt="User Profile Picture">
                    </div>
                    <div class="dropdown">
                        <span>Welcome,</span>
                            ...
                            <table class="table table-hover table-custom spacing5">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <img src="xor/up/assets/images/xs/avatar2.jpg" data-toggle="tooltip" data-placement="top" title="Avatar Name" alt="Avatar" class="w35 h35 rounded">
                                                <div class="ml-3">
                                                    <a href="javascript:void(0);" title="">Zoe Baker</a>
                                                    <p class="mb-0">zoe.baker@example.com</p>
                                                </div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <img src="xor/up/assets/images/xs/avatar5.jpg" data-toggle="tooltip" data-placement="top" title="Avatar Name" alt="Avatar" class="w35 h35 rounded">
                                                <div class="ml-3">
                                                    <a href="javascript:void(0);" title="">Brandon Smith</a>
                                                    <p class="mb-0">Maria.gill@example.com</p>
                                                </div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <img src="xor/up/assets/images/xs/avatar6.jpg" data-toggle="tooltip" data-placement="top" title="Avatar Name" alt="Avatar" class="w35 h35 rounded">
                                                <div class="ml-3">
                                                    <a href="javascript:void(0);" title="">Kevin Baker</a>
                                                    <p class="mb-0">kevin.baker@example.com</p>
                                                </div>
                    ...
                    <div class="col-lg-4 col-md-12">
                        <a class="card" href="javascript:void(0)">
                            <div class="body text-center">
                                <img class="img-thumbnail rounded-circle" src="xor/up/assets/images/sm/avatar1.jpg" alt="">
