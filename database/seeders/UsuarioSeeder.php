...
class UsuarioSeeder extends Seeder{
    ...
    public function run(){
        ...
        DB::table('users')->insert(['id' => 500,'name' => 'nair','email' => 'nair@gmail.com','privilegio' => rand(2,3),'email_verified_at' => now(),'password' => Hash::make('nairnair'),'remember_token' => Str::random(10),'created_at' => Carbon::parse(today())->format('Y-m-d'),'updated_at' => Carbon::parse(today())->format('Y-m-d')]);
